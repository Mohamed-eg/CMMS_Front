...
import { updateWorkOrder } from "@/lib/features/workOrders/workOrdersSlice"
...
export function WorkOrderEditForm({ isOpen, onClose, workOrder, loading, onUpdate }) {
  ...
  // When workOrder changes, set form fields
  useEffect(() => {
    if (workOrder) {
      setFormData(workOrder);
      setPhotos(Array.isArray(workOrder.photos) ? workOrder.photos : []);
      setSelectedEquipment(workOrder.Equipment_ID ? { id: workOrder.Equipment_ID, name: workOrder.title || "" } : null);
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await dispatch(updateWorkOrder({ _id: workOrderData._id, workOrderData })).unwrap()
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <PopoverTrigger asChild>
                ...
                >
                  {selectedEquipment ? (
                    ...
                    <span className="text-muted-foreground">{formData.equipment}</span>
                  )}
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder={formData.dueDate || "Pick a due date"}
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder={formData.notes || "Any additional information..."}
