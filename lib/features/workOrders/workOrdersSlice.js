...
import { getWorkOrders, deleteWorkOrder, createWorkOrder, updateWorkOrder as updateWorkOrderApi } from "../../../lib/api/workorders"
...
export const updateWorkOrder = createAsyncThunk("workOrders/updateWorkOrder", async ({ _id, workOrderData }) => {
  console.log(_id, workOrderData)
  const updatedWorkOrder = await updateWorkOrderApi(_id, workOrderData);
